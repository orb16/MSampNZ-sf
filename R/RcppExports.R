...
log_b <- function(x, base) {
    .Call('_MSampSF_log_b', PACKAGE = 'MSampSF', x, base)
}
...
HaltonSeq <- function(k, base, n) {
    .Call('_MSampSF_HaltonSeq', PACKAGE = 'MSampSF', k, base, n)
}
...
GetBoxIndices <- function(lxy, base, J) {
    .Call('_MSampSF_GetBoxIndices', PACKAGE = 'MSampSF', lxy, base, J)
}
...
SolveCongruence <- function(A, base, J) {
    .Call('_MSampSF_SolveCongruence', PACKAGE = 'MSampSF', A, base, J)
}
